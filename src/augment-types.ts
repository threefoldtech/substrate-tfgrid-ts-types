...
import type { Cause, Consumption, Contract, ContractBill, ContractBillingInformation, ContractData, ContractResources, ContractState, DiscountLevel, NameContract, NodeContract, NruConsumption, RentContract } from 'substrate-tfgrid-ts-types/src/smartContractModule';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    Twin: Twin;
    'Option<Twin>': Option<Twin>;
    'Vec<Twin>': Vec<Twin>;
    EntityProof: EntityProof;
    'Option<EntityProof>': Option<EntityProof>;
    'Vec<EntityProof>': Vec<EntityProof>;
    Node: Node;
    ...
    'Option<CertificationCodeType>': Option<CertificationCodeType>;
    'Vec<CertificationCodeType>': Vec<CertificationCodeType>;
    CertificationCodes: CertificationCodes;
    'Option<CertificationCodes>': Option<CertificationCodes>;
    'Vec<CertificationCodes>': Vec<CertificationCodes>;
    ...
    'Option<NameRegistration>': Option<NameRegistration>;
    'Vec<NameRegistration>': Vec<NameRegistration>;
    FarmingPolicy: FarmingPolicy;
    'Option<FarmingPolicy>': Option<FarmingPolicy>;
    'Vec<FarmingPolicy>': Vec<FarmingPolicy>;
    Public: Public;
    'Option<Public>': Option<Public>;
    'Vec<Public>': Vec<Public>;
    U16F16: U16F16;
    'Option<U16F16>': Option<U16F16>;
    'Vec<U16F16>': Vec<U16F16>;
    ...
    'Option<ContractData>': Option<ContractData>;
    'Vec<ContractData>': Vec<ContractData>;
    NodeContract: NodeContract;
    'Option<NodeContract>': Option<NodeContract>;
    'Vec<NodeContract>': Vec<NodeContract>;
    NameContract: NameContract;
    'Option<NameContract>': Option<NameContract>;
    'Vec<NameContract>': Vec<NameContract>;
    RentContract: RentContract;
    'Option<RentContract>': Option<RentContract>;
    'Vec<RentContract>': Vec<RentContract>;
    NruConsumption: NruConsumption;
    'Option<NruConsumption>': Option<NruConsumption>;
    'Vec<NruConsumption>': Vec<NruConsumption>;
    ...
    'Option<ContractResources>': Option<ContractResources>;
    'Vec<ContractResources>': Vec<ContractResources>;
    Cause: Cause;
