...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    tfgridModule: {
      ...
      createPricingPolicy: AugmentedSubmittable<(name: Bytes | string | Uint8Array, unit: Unit | 'Bytes' | 'Kilobytes' | 'Megabytes' | 'Gigabytes' | number | Uint8Array, su: u32 | AnyNumber | Uint8Array, cu: u32 | AnyNumber | Uint8Array, nu: u32 | AnyNumber | Uint8Array, ipu: u32 | AnyNumber | Uint8Array, foundationAccount: AccountId | string | Uint8Array, certifiedSalesAccount: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
